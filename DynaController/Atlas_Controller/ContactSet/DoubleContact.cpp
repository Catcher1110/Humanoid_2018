...
bool DoubleContact::_UpdateJc(){
  ...
  robot_sys_->getFullJacobian(atlas_link::rightFoot, Jtmp);
  Jc_.block(0, 0, 6, atlas::num_qdot) = Jtmp;

  robot_sys_->getFullJacobian(atlas_link::leftFoot, Jtmp);
  Jc_.block(6, 0, 6, atlas::num_qdot) = Jtmp;
